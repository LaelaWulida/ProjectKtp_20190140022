 ...
 */
package unujojgja.project.ktp.coba;
...
import unujojgja.project.ktp.coba.exceptions.NonexistentEntityException;
import unujojgja.project.ktp.coba.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("unujojgja_project.ktp_jar_0.0.1-SNAPSHOTPU");
